    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 积分商品列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                  ...
                  <el-form-item style="float: right;">
                      <el-button type="primary" @click="addGoods" v-has="'JFSCTJ'">新增</el-button>
                  </el-form-item>
                </el-form>
            </div>
            <el-table
            ...
            >
                ...
                <el-table-column prop="goodsInfo" label="商品描述" show-overflow-tooltip></el-table-column>
...
export default {
    ...
    methods: {
        // 获取 easy-mock 的模拟数据
        getData() {
            fetchData(`/xy-shop-goods-list/currentPage/${this.pageIndex}/pageSize/10`,this.query).then(res => {
