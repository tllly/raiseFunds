            ...
            <div class="handle-box">
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                  <el-form-item style="float: right;">
                      <el-button type="primary" @click="addGoods" v-has="'BMDTJ'">新增</el-button>
                  </el-form-item>
                </el-form>
            </div>
            <el-table
...
export default {
    ...
    methods: {
        // 获取商品分类列表
        getTypeList(){
            fetchData(`/white-list/WhiteList/currentPage/${this.pageIndex}/pageSize/10`).then(res => {
        ...
        onSubmit(formName){
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    postData(`/white-list/add`,this.form).then(res => {
                        if(res.code == 200){
